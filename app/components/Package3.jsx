...
import img1 from '../../public/assets/img/service/office.jpg';
import icn1 from '../../public/assets/img/icon/office.png';

const Package3 = ({ title }) => {
    return (
        <>
                ...
                <div className="tp-quality mb-30 wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <div className="tp-quality-text text-center">
                        <div className="tp-quality-text-icon mb-10">
                            <Link href="/home/packages/office">
                                <Image className="tp-quality-text-icon1" src={icn1} alt="Office clean icon" />
                                <i className="tp-quality-text-icon2"><HiPlus className="text-white" /></i>
                            </Link>
                        </div>
                        <span>Commercial</span>
                        <h4 className="tp-quality-text-title m-0"><Link href="/home/packages/office">{title}</Link></h4>
                    </div>
                </div>
            </div>
        </>
