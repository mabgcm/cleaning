...
import img1 from '../../public/assets/img/service/regular.jpg';
import icn1 from '../../public/assets/img/icon/regular.png';

const Package4 = ({ title }) => {
    return (
        <>
            <div className="col-xl-4 col-md-6">
                <div className="tp-quality mb-30 wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <div className="tp-quality-text text-center">
                        ...
                        <h4 className="tp-quality-text-title m-0"><Link href="/home/packages/regular">{title}</Link></h4>
                    </div>
                </div>
            </div>
        </>
